...
abstract class $SettingStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ThemeMode themeMode, String langCode});
}
...
class _$_SettingState implements _SettingState {
  const _$_SettingState(
      {this.themeMode = ThemeMode.light, this.langCode = 'en'});
  ...
  @override
  String toString() {
    return 'SettingState(themeMode: $themeMode, langCode: $langCode)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, themeMode, langCode);
...
abstract class _SettingState implements SettingState {
  const factory _SettingState(
      {final ThemeMode themeMode, final String langCode}) = _$_SettingState;
